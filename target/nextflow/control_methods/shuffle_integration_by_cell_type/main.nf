// shuffle_integration_by_cell_type build_test_python_package
// 
...
meta = [
  ...
  "version" : "build_test_python_package",
  "argument_groups" : [
    {
      "name" : "Arguments",
      "arguments" : [
  ...
  "resources" : [
    ...
    {
      "type" : "file",
      "path" : "/common/python_helpers/run.py"
    },
    {
      "type" : "file",
      "path" : "/common/python_helpers/__init__.txt",
      "dest" : "__init__.py"
    }
  ],
  ...
  "build_info" : {
    ...
    "viash_version" : "0.9.4",
    "git_commit" : "de5b9c2838768de2c86fa0f524a3507f98eb4094",
  ...
  "package_config" : {
    ...
    "target" : "target",
    "config_mods" : [
      ".runners[.type == \\"nextflow\\"].config.labels := { lowmem : \\"memory = 20.Gb\\", midmem : \\"memory = 50.Gb\\", highmem : \\"memory = 100.Gb\\", lowcpu : \\"cpus = 5\\", midcpu : \\"cpus = 15\\", highcpu : \\"cpus = 30\\", lowtime : \\"time = 1.h\\", midtime : \\"time = 4.h\\", hightime : \\"time = 8.h\\", veryhightime : \\"time = 24.h\\" };\n.resources += { path: \\"/common/python_helpers/run.py\\" };\n.resources += { path: \\"/common/python_helpers/__init__.txt\\", dest: \\"__init__.py\\" }\n"
    ],
    "authors" : [
      {
