// geneformer_mlflow build_feature_no_ref_add_mlflow_models
// 
...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "file",
          "name" : "--model",
          "description" : "An MLflow model URI for the Geneformer model. If it is a .zip or\n.tar.gz file it will be extracted to a temporary directory.\n",
          "must_exist" : true,
          "create_parent" : true,
          "required" : true,
          "direction" : "input",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_batch_integration/task_batch_integration/src/methods/geneformer_mlflow/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/methods/geneformer_mlflow",
    "viash_version" : "0.9.4",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_batch_integration/methods/geneformer_mlflow",
