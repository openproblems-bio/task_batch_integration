...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_batch_integration/task_batch_integration/src/methods/seurat_rpca/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/methods/seurat_rpca",
    "viash_version" : "0.9.4",
...
par <- list(
  ...
  "dims" = $( if [ ! -z ${VIASH_PAR_DIMS+x} ]; then echo -n "as.integer('"; echo -n "$VIASH_PAR_DIMS" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "')"; else echo NULL; fi ),
  "k_anchor" = $( if [ ! -z ${VIASH_PAR_K_ANCHOR+x} ]; then echo -n "as.integer('"; echo -n "$VIASH_PAR_K_ANCHOR" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "')"; else echo NULL; fi ),
  "k_filter" = $( if [ ! -z ${VIASH_PAR_K_FILTER+x} ]; then echo -n "as.integer('"; echo -n "$VIASH_PAR_K_FILTER" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "')"; else echo NULL; fi ),
  "k_score" = $( if [ ! -z ${VIASH_PAR_K_SCORE+x} ]; then echo -n "as.integer('"; echo -n "$VIASH_PAR_K_SCORE" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "')"; else echo NULL; fi )
)
meta <- list(
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_batch_integration/methods/seurat_rpca",
    "tag" : "build_main"
  },
  "label" : [
    "midcpu",
