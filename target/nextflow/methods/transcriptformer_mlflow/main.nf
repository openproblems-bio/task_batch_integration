// transcriptformer_mlflow build_feat_transcriptformer_mlflow
// 
...
meta = [
  ...
  "namespace" : "methods",
  "version" : "build_feat_transcriptformer_mlflow",
  "argument_groups" : [
    {
      "name" : "Arguments",
      "arguments" : [
        ...
        },
        {
          "type" : "file",
          "name" : "--model",
          "description" : "An MLflow model URI for the transcriptformer model. If it is a .zip or\n.tar.gz file it will be extracted to a temporary directory.\n",
          "must_exist" : true,
          "create_parent" : true,
          "required" : true,
          "direction" : "input",
      ...
      "setup" : [
        {
          "type" : "docker",
          "add" : [
            "https://astral.sh/uv/0.7.19/install.sh /uv-installer.sh"
          ],
          "run" : [
        ...
        },
        {
          "type" : "docker",
          "run" : [
            "uv pip install git+https://github.com/openproblems-bio/core#subdirectory=packages/python/openproblems"
          ]
        }
      ]
    }
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_batch_integration/task_batch_integration/src/methods/transcriptformer_mlflow/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/methods/transcriptformer_mlflow",
    "viash_version" : "0.9.4",
    "git_commit" : "b7dae0b4b7b98a17a3966ded2ffaaa8335379a20",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_batch_integration/methods/transcriptformer_mlflow",
    "tag" : "build_feat_transcriptformer_mlflow"
  },
  "label" : [
    "hightime",
    "highmem",
