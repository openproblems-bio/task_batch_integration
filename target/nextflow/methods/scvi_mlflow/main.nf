// scvi_mlflow build_feature_no_ref_add_mlflow_models
// 
...
meta = [
  ...
  "name" : "scvi_mlflow",
  "namespace" : "methods",
  "version" : "build_feature_no_ref_add_mlflow_models",
  "argument_groups" : [
    {
      "name" : "Arguments",
      "arguments" : [
        ...
        },
        {
          "type" : "file",
          "name" : "--model",
          "description" : "An MLflow model URI for the scVI model. If it is a .zip or\n.tar.gz file it will be extracted to a temporary directory.\n",
          "must_exist" : true,
          "create_parent" : true,
          "required" : true,
          "direction" : "input",
  ...
  "engines" : [
    {
      ...
      "setup" : [
        ...
        },
        {
          ...
          "run" : [
            "uv pip install -r /requirements.txt && uv pip install mlflow==3.1.0"
          ],
          "env" : [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_batch_integration/task_batch_integration/src/methods/scvi_mlflow/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_batch_integration/methods/scvi_mlflow",
    "tag" : "build_feature_no_ref_add_mlflow_models"
  },
  "label" : [
    "hightime",
    "highmem",
