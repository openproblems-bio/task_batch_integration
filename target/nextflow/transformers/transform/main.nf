...
meta = [
  ...
  "description" : "Transform corrected feature output to an embedding, and an embedding to a graph output.\n",
  "test_resources" : [
    {
      "type" : "python_script",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_batch_integration/task_batch_integration/src/transformers/transform/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/transformers/transform",
    "viash_version" : "0.9.0",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_batch_integration/transformers/transform",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
